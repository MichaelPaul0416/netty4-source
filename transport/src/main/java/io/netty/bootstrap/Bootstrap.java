...
public class Bootstrap extends AbstractBootstrap<Bootstrap, Channel> {
    ...
    private ChannelFuture doResolveAndConnect(final SocketAddress remoteAddress, final SocketAddress localAddress) {
        final ChannelFuture regFuture = initAndRegister();//初始化Channel,并且注册
    ...
    private ChannelFuture doResolveAndConnect0(final Channel channel, SocketAddress remoteAddress,
        ...
        try {
            ...
            final AddressResolver<SocketAddress> resolver = this.resolver.getResolver(eventLoop);//DefaultAddressResolverGroup
            ...
            final Future<SocketAddress> resolveFuture = resolver.resolve(remoteAddress);//异步解析
    ...
    void init(Channel channel) throws Exception {
        ...
        p.addLast(config.handler());//将NioSocketHandler加入
